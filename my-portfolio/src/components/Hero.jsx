    ...
    <div className="relative min-h-screen flex flex-col justify-center px-4 sm:px-10 py-16 sm:py-30 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          >
           <span className="text-secondary  text-bold  text-xl font-mono" > I'm</span> an experienced Full-Stack Web Developer passionate about transforming innovative ideas into powerful digital solutions.
          </motion.p>
        </div>
