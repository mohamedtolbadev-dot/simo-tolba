          ...
          >
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <p
                  className={`text-slate-300 text-lg lg:text-xl max-w-2xl leading-relaxed ${isArabic ? "font-arabic mr-0 ml-auto" : ""
                    }`}
                >
                  {description}
                </p>
            ...
            >
              <Link
                to="/projects"
                className={`group inline-flex items-center gap-3 px-8 py-4 bg-secondary text-primary rounded-lg font-medium shadow-lg shadow-secondary/20 hover:shadow-xl hover:shadow-secondary/30 transition-all duration-300 ${isArabic ? "flex-row-reverse font-arabic" : ""
                  }`}
              >
                {viewProjects}
                {isArabic ? (
